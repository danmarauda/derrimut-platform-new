            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-8">
                <Button
                  ...
                  variant="primary"
                  asChild
                  className="px-12 py-6 text-lg font-semibold rounded-md transition-all duration-300 shadow-lg hover:shadow-primary/25"
                >
                ...
                <Button
                  ...
                  variant="secondary"
                  asChild
                  className="px-12 py-6 text-lg font-semibold rounded-md transition-all duration-300"
                >
      ...
      <section className="relative z-10 py-24 bg-muted/30">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 xl:px-32">
          ...
          <div className="text-center mb-16">
            <Badge variant="standard" className="mb-4 px-4 py-2 text-sm font-medium">
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 xl:px-32">
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-3xl p-12 text-center border-2 border-primary/20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="secondary" asChild className="px-12 py-6 text-lg font-semibold">
      ...
      <section className="relative z-10 py-16">
        <div className="container mx-auto px-6 md:px-12 lg:px-20 xl:px-32">
          ...
          <div className="text-center mt-12">
            <Button size="lg" asChild variant="secondary" className="px-12 py-6 text-lg font-semibold">
              <Link href="/about">
