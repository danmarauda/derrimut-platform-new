        ...
        {blogStats && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="bg-card border-border">
              ...
              <CardContent>
                <div className="text-2xl font-bold text-foreground">{blogStats.totalLikes}</div>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <select
                ...
                className="bg-background border border-border text-foreground rounded-md px-3 py-2"
              >
